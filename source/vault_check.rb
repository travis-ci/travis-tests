...
if ENV['SECRET_KEY_A_MESSAGE']
  ...
  puts "SECRET_KEY_A_MESSAGE: this_should_be_printed_out_#{ENV['SECRET_KEY_A_MESSAGE']}"
else
...
if ENV['SECRET_KEY_B_CLIMATE']
  ...
  puts "SECRET_KEY_A_MESSAGE: this_should_be_printed_out_#{ENV['SECRET_KEY_B_CLIMATE']}"
else
